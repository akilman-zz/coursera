...
trait GameDef {
  ...
  case class Block(b1: Pos, b2: Pos) {
     ...
     * 
     * Logic: The game plain is a wonky cartesian graph, hence both blocks should occupy the same x,y coordinates
     */
     ...
     * 
     * Logic: Terrain is a function which determines if a Pos is in the terrain (via returning true/false). Each
     * block occupies one coordinate, hence a simple and should do the trick
     */
